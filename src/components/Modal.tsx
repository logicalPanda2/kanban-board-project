	...
	return (
		<div className="fixed inset-0 bg-gray-500/70 flex items-center justify-center">
            <div className="w-lg h-96 rounded-2xl px-6 py-4 bg-white flex flex-col relative">
                <p className="text-3xl mb-4">{editedId ? "Edit a task" : "Create a task"}</p>
                <div className="flex flex-col w-3/4">
                    <label htmlFor="titleField" className="text-xl mb-1">Title</label>
                    <input
                        type="text"
                        name="title"
                        id="titleField"
                    ...
                    />
                    {hasError && <p className="text-xs mb-1">Title cannot be empty</p>}
                    <label htmlFor="detailsField" className="text-xl mb-1">Details</label>
                    <input
                        type="text"
                        name="details"
                        id="detailsField"
                    ...
                    />
                    <label htmlFor="tagField" className="text-xl mb-1">Tag</label>
                ...
                <button onClick={onClose} className="absolute top-5 right-6">X</button>
            </div>
		</div>
	);
}
